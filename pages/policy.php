    ...
    <div class="container-main">
        <div class="row g-4">
            ...
            <div class="col-lg-2 col-6">
                ...
                <ul class="footer-links">
                    <li><a href="policy.php?tab=return">Đổi trả hàng</a></li>
                    <li><a href="policy.php?tab=warranty">Bảo hành</a></li>
                    <li><a href="policy.php?tab=shipping">Vận chuyển</a></li>
                    <li><a href="policy.php?tab=privacy">Bảo mật</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6">
