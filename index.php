        ...
        <div class="navbar-inner">
            ...
            <div class="cat-dropdown">
                ...
                <div class="cat-dropdown-menu">
                    ...
                    <?php endwhile; ?>
                    <a href="pages/products.php" class="cat-dropdown-item" style="border-top:1px solid #f0f0f0;margin-top:4px;color:#0057FF">
                        <span class="cat-icon">🔍</span> Xem tất cả sản phẩm
                    </a>
                </div>
            </div>
    ...
    <div class="quick-cats">
        <div class="quick-cats-inner">
            <a href="pages/products.php" class="quick-cat-item active">
                <i class="bi bi-grid-fill qc-icon"></i> Tất cả
            </a>
            <?php
            $categories->data_seek(0); $i = 0;
            $cat_bi_icons = ['bi-phone', 'bi-headphones', 'bi-plug', 'bi-phone-flip', 'bi-smartwatch', 'bi-laptop'];
            while ($cat = $categories->fetch_assoc()):
                $icon = $cat_bi_icons[$i % count($cat_bi_icons)]; $i++;
            ?>
            <a href="pages/products.php?category=<?= $cat['slug'] ?>" class="quick-cat-item">
                <i class="bi <?= $icon ?> qc-icon"></i>
                <?= htmlspecialchars($cat['name']) ?>
            </a>
            <?php endwhile; ?>
            <a href="pages/products.php?sort=discount" class="quick-cat-item">
                <i class="bi bi-tags-fill qc-icon"></i> Khuyến mãi
            </a>
        </div>
    </div>
        ...
        <div class="container-main">
            ...
            <?php else: ?>
                <div class="text-center py-5 text-muted">
                    ...
                    <p class="mt-2">Chưa có sản phẩm nổi bật. Thêm sản phẩm trong trang quản trị!</p>
                </div>
            <?php endif; ?>
        </div>
    </section>
            ...
            <div class="promo-grid">
                ...
                <div class="promo-card">
                    ...
                    <?php if ($promo['end_date']): ?>
                        <div class="promo-desc" style="margin-top:12px">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-2 col-md-6 col-6">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="pages/products.php?category=sac-cap">Sạc & Cáp</a></li>
                        <li><a href="pages/products.php?category=op-lung">Ốp lưng</a></li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-6 col-6">
